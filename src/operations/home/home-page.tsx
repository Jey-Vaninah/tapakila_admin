...
export const HomePage = () => {
  const { data: currentEvents = [], isLoading: isLoadingEvents } =
    useGetList("current-event");
  const { data: currentTickets = [], isLoading: isLoadingTickets } =
    useGetList("current-ticket");
    ...
    <Box>
      ...
      <FlexBox sx={{ mt: 2 }}>
        ...
        >
          ...
          >
            <EventIcon
              sx={{ color: "rgb(43, 200, 190)", mt: "5px", fontSize: 40 }}
            />
          </Box>
        </Paper>
        <Paper
        ...
        >
          <Box>
            ...
            <Typography sx={{ fontWeight: "bold", fontSize: "1.5rem" }}>
              {dataTickets.reduce(
                (sum, ticket) => sum + parseInt(ticket.ticketNumber),
                0
              ) ? (
                dataTickets.reduce(
                  (sum, ticket) => sum + parseInt(ticket.ticketNumber),
