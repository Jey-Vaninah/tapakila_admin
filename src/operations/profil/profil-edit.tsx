...
const ProfileEdit = () => {
  ...
  const onSubmitInfo = async (formData: UserUpdate) => {
    ...
    if (!userProvider?.saveOrUpdate) {
      notify("Erreur: le service userProvider n'est pas disponible.", {
        type: "error",
      });
      return;
    }
    ...
    try {
      await userProvider.saveOrUpdate({
        data: { ...formData, imageUrl: imageUrl },
      ...
      console.log(error);
      notify("Erreur lors de la mise à jour des informations", {
        type: "error",
      });
    } finally {
          ...
          >
            ...
            <Stack spacing={2}>
              ...
              <TextField
                ...
                {...registerInfo("username", { required: true })}
                margin="normal"
                error={!!errorsInfo.username}
                helperText={errorsInfo.username && "Nom requis"}
              />
              <TextField
                fullWidth
                label="Nom"
                {...registerInfo("name", { required: true })}
                margin="normal"
                error={!!errorsInfo.name}
                helperText={errorsInfo.name && "Nom requis"}
              />
              <TextField
                fullWidth
                label="Email"
                {...registerInfo("email", { required: true })}
                margin="normal"
                error={!!errorsInfo.email}
                helperText={errorsInfo.email && "Email requis"}
              />
            ...
            <Button
              ...
              sx={{ mt: 2, bgcolor: "rgb(43, 200, 190)", color: "white" }}
            >
          ...
          >
            ...
            <Stack spacing={2}>
              <TextField
                ...
                margin="normal"
                error={!!errorsSecurity.password}
                helperText={errorsSecurity.password && "Mot de passe requis"}
              />
              <TextField
                fullWidth
                ...
                margin="normal"
                error={!!errorsSecurity.newPassword}
                helperText={errorsSecurity.newPassword && "Mot de passe requis"}
              />
              <TextField
                fullWidth
                ...
                margin="normal"
                error={!!errorsSecurity.confirmPassword}
