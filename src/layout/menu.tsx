import { Avatar, Box, Typography, MenuItem, ListItemIcon, ListItemText } from "@mui/material";
	...
	return (
		<MenuItem
			...
			sx={{
				...
				borderLeft: isActive ? "4px solid rgb(43, 200, 190)" : "4px solid transparent",
	...
	return (
		...
		>
			...
			<Box sx={{ width: "100%", textAlign: "center", }}>
				...
				>
					<Avatar sx={{ width: "85px", height: "85px", mb: 1 }} src={profileImage} />
