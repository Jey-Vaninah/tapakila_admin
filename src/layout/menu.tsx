...
export const Menu: FC = () => {
    return (
        <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "space-between", p: 3, bgcolor: "black", width: "300px", height: "100%" }}>
            <Box sx={{width: "100%"}}>
                <Box sx={{ mb: 1, width: "100%", flexDirection: "column", display: "flex", alignItems: "center", justifyContent: "center" }}>
