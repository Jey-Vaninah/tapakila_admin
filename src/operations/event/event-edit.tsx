...
const ImageUploadField: React.FC<ImageUploadFieldProps> = ({ imageUrl, handleImageUpload }) => {
	...
	return (
		<Paper elevation={3} sx={{ p: 3, mb: 2, textAlign: "center" }}>
			...
			<Button variant="contained" component="label" startIcon={<CloudUploadIcon />} sx={{ textTransform: "none" }}>
				Upload Image
				<input
					type="file"
					hidden
...
export const EventEdit = () => {
	...
	return (
		<Edit resource="event" actions={<EventEditActions />}
			transform={(data) => ({
				...data,
		...
		>
			<SimpleForm toolbar={<CustomToolbar />}>
				<div style={{
					...
					<ImageUploadField imageUrl={imageUrl} handleImageUpload={handleImageUpload} />
					<div>
						<SelectInput
							label="Event Hall"
							source="eventHall.id"
